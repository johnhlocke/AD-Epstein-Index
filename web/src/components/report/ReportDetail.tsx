...
import { DossierAestheticRadar, ScoringBreakdown } from "@/components/dossier/DossierAestheticRadar";
...
export function ReportDetail({ report }: ReportDetailProps) {
  const { feature, issue, images, dossier, wealth, fame, crossRef } = report;
  ...
  return (
    <div style={{ backgroundColor: pageBg, minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      <SectionContainer width="wide" className="relative z-[1] pt-4 pb-12">
          ...
          <div style={{ gridColumn: "5 / 7", gridRow: "2", fontFamily: "futura-pt, sans-serif", fontSize: "10px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", display: "flex", flexDirection: "column" }}>
            ...
            <div className="flex justify-between px-1" style={{ flex: 1, minHeight: 28, alignItems: "center" }}>
              ...
              <span style={{ color: "#1A1A1A", fontWeight: 700 }}>
                {dossier?.sibling_dossiers?.length
        ...
        {/* Section B: Epstein Connection — only if dossier exists */}
        {hasDossier && (
        <>
          ...
          <div className="mt-4" style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "24px" }}>
            {dossier.connection_summary && (
              <div style={{ gridColumn: "1 / 5" }}>
                ...
                {(() => {
                  const dojResults = crossRef?.doj_results as Record<string, unknown> | null;
        ...
        {/* Aesthetic Profile section — collapsible */}
        <CollapsibleSection label={`Section ${hasDossier ? "C" : "B"}:`} title="Aesthetic Profile" titleBg={pageBg}>
        ...
        <div className="mt-4" style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "24px" }}>
          ...
          <div style={{ gridColumn: "5 / 7" }}>
            ...
            <div style={{ borderTop: "1px solid #000" }} />
            {images.length > 0 && <ScatteredPages images={images} />}
          </div>
        </div>
        ...
        {hasDossier && (
          <div className="mt-12">
            ...
            <div className="mt-5 space-y-4">
              ...
              <EvidenceSection title="Key Findings" data={dossier.key_findings} pageBg={pageBg} />
              <EvidenceSection title="Visual Analysis" data={dossier.visual_analysis} pageBg={pageBg} />
            </div>
          </div>
        )}
